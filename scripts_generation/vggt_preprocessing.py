...
def parse_args():
    ...
    parser.add_argument("--background_threshold", type=int, default=3, help="Pixel threshold for background detection (default: 3 - any pixel value above this is foreground)")
